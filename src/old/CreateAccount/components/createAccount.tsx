...
function App() {
  ...
  const handleAccountCreation = (e: React.FormEvent) => {
    ...
    setMessage(hasEmptyFields ? t('fill_in_all_fields') : t('processing...'))
  }
  ...
  return (
    <main>
      ...
      <form className="">
        ...
        <button onClick={handleAccountCreation}>{t('create account')}</button>
      </form>
